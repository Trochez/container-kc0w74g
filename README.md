...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kc0w74g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kc0w74g.containers.anotherwebservice.com/
...
```
git clone git@github.com:Trochez/container-kc0w74g.git
cd container-kc0w74g
```
...
```
docker attach container-kc0w74g
```
